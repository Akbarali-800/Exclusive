...
// const topProducts2 = [
//   { id: 12, name: "Breed Dry Dog Food", price: 960, rating: 5, image: product12 },
//   { id: 13, name: "CANON EOS DSLR Camera", price: 260, rating: 4, image: product13 },
//   { id: 14, name: "ASUS FHD Gaming Laptop", price: 14.99, rating: 2, image: product14 },
//   { id: 15, name: "Curology Product Set ", price: 124.99, rating: 3, image: product15 },
//   { id: 16, name: "Kids Electric Car", price: 960, rating: 5, image: product16 },
//   { id: 17, name: "Jr. Zoom Soccer Cleats", price: 260, rating: 4, image: 17 },
//   { id: 18, name: "GP11 Shooter USB Gamepad", price: 14.99, rating: 2, image: product18 },
//   { id: 19, name: "Quilted Satin Jacket", price: 124.99, rating: 3, image: product19 },
// ];
...
//         {/* Top Products Section (faqat product8–11) */}
...
//                   src={product.image}
//                   alt={product.name}
//                   className={`product-image product-${product.id}`}
//                 />
//                 <h3 className="product_name2">{product.name}</h3>
